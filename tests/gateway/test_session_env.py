...
def test_set_session_env_sets_contextvars(monkeypatch):
    ...
    tokens = runner._set_session_env(
        context,
        current_user_message="https://youtu.be/example",
    )
    ...
    assert get_session_env("HERMES_CURRENT_USER_MESSAGE") == "https://youtu.be/example"

    # os.environ should NOT be touched
    assert os.getenv("HERMES_SESSION_PLATFORM") is None
    assert os.getenv("HERMES_SESSION_THREAD_ID") is None
    assert os.getenv("HERMES_CURRENT_USER_MESSAGE") is None
...
def test_clear_session_env_restores_previous_state(monkeypatch):
    ...
    assert get_session_env("HERMES_CURRENT_USER_MESSAGE") == ""
